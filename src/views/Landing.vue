...
-->
  <div class="bg-white">
    ...
    <main>
      <div class="bg-bar-pattern bg-cover">
        <div
          class="relative mx-auto max-w-7xl w-full pt-16 text-center lg:py-48 lg:text-left"
        >
          <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
            <h1
              class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl"
            >
              <span class="block text-white xl:inline">Data to enrich your </span>
          ...
          >
          <div class="rounded-lg h-full p-5">
            <div class="border-yellow-600 border-4 bg-cover shadow rounded-lg h-full p-5 bg-bar-glasses-hero lg:bg-cover sm:bg-center">
            </div>

            <!-- <img
              class="rounded-md inset-0 w-full h-full object-cover"
              src="https://images.unsplash.com/photo-1520333789090-1afc82db536a?ixlib=rb-1.2.1&ixqx=Fki2CBuJXP&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80"
              alt=""
            /> -->
          </div>
        </div>
...
--><!-- This example requires Tailwind CSS v2.0+ -->
      ...
      <!-- <div class="relative">
        <div class="absolute inset-x-0 bottom-0 h-full bg-black"></div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8">
          <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            <div class="absolute inset-0">
              <img
                class="h-full w-full object-cover"
                src="../../public/kelsey-chance-tAH2cA_BL5g-unsplash.jpg"
                alt="People working on laptops"
              />
              <div
                class="absolute inset-0 bg-gray-700 bg-opacity-25"
