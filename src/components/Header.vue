<template>
  <header class="bg-gray-800 shadow">
    <div class="max-w-7xl mx-auto bg-gray-800 shadow">
      <div
        class="relative z-20 pb-6 sm:pb-8 md:pb-8 lg:max-w-2xl lg:w-full"
        x-data
      >
        <!-- <svg
          ...
          >
            ...
            >
              <div class="flex items-center justify-between w-full md:w-auto">
                <!-- Logo and hmburger menu spacing -->
                <a href="#">
      ...
      -->
        <div
          ...
          x-on:click.away="$store.nav.toggle()"
          x-show="$store.nav.open === true"
          x-data
        >
          <div
    ...
    <!-- <div class="relative bg-white">
      ...
      >
        ...
        <div class="-mr-2 -my-2 md:hidden">
          <button
            x-on:click="$store.nav.toggleMobile()"
            type="button"
            class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
            aria-expanded="false"
          >
    ...
    <!-- <div
                ...
                x-transition:enter-start="opacity-0 opacity-0 translate-y-1"
                x-transition:enter-end="opacity-100 opacity-0 translate-y-0"
                x-transition:leave="transition ease-in duration-300"
                x-transition:leave-start="opacity-100 opacity-0 translate-y-0"
  ...
  -->
    <!-- <div
        ...
        x-transition:leave-start="opacity-100 scale-100"
        x-transition:leave-end="opacity-0 scale-95"
        x-on:click.away="$store.nav.toggleMobile()"
        x-show="$store.nav.mobileOpen === true"
      >
        <div
        ...
        >
          <div class="pt-5 pb-6 px-5">
            ...
            <div class="mt-6" x-show="$store.nav.mobileOpen">
          ...
          <div class="py-6 px-5 bg-gray-600">
